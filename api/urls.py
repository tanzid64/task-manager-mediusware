...
from .views import UserRegistrationAPIView, UserLoginAPIView, UserLogoutAPIView, UserProfileAPIView, TaskDetailAPIView, TaskCompleteAPIView, TaskViewSet, UserPasswordChangeAPIView, PasswordResetAPIView
